...
**`grain_opacity`** — kekuatan butiran di bingkai potret panel chat, `0` sampai `1`. Bawaan
...
Satu field khusus: **`system_in_user`**. Sebagian model menolak *system
instruction*, padahal persona Amadeus tinggal di sana. Dinyalakan berarti
personanya digabungkan ke pesan pertamamu. Bawaannya mati — Gemma lewat
